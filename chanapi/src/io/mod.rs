//! Async byte-stream I/O traits owned by chanapi.
//!
...
//!
//! chanapi core stays runtime-neutral: nothing here depends on tokio,
...
//! pulling `futures-io` into chanapi core as a mandatory dep, and keeps
